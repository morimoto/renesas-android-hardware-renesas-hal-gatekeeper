...
public:
    OpteeGateKeeperDevice(const hw_module_t *module);
    ...
    /**
     * Concerts object to gatekeeper device
     */
...
private:
    ...
    /**
     * Closes gatekeeper device and deletes object that manages it
     */
    static int close_device(hw_device_t *dev);

    gatekeeper_device gatekeeperDevice;
    OpteeIPC gatekeeperIPC;
    bool connected;
};
}
